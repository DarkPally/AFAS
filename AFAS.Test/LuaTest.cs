...
namespace AFAS.Test
{
    class LuaTest
    {
        ...
        public const string ProgramSource2 = "local a, b = tonumber(read(\"a\")), tonumber(read(\"b\"));\n\n" +
        "local PrintResult = function(o, op)\n" +
        "		print(o.. ' = ' .. a..op..b);\n" +
        "end;\n\n" +
        "PrintResult(a + b, \" + \");\n";
        ...
        public static void Main1(string[] args)
        {
            ...
            using (var l = new Lua())
            {
                ...
                var chunk2 = l.CompileChunk(ProgramSource2, "test2.lua", new LuaCompileOptions() { DebugEngine = LuaStackTraceDebugger.Default }); // compile the script with debug informations, that is needed for a complete stack trace
